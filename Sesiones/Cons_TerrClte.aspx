<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cons_TerrClte.aspx.cs" Inherits="BitOp.Sesiones.Cons_TerrClte" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <p class="auto-style10">
        <strong>HISTORICO DE TERRITORIOS x CLIENTE</strong></p>
    <p>
        Región:
