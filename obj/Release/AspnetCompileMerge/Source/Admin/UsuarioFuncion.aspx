    ...
    <p>
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                    ...
                    <Columns>
                        <asp:TemplateField ShowHeader="False">
                            ...
                            <ItemTemplate>
                                ...
                                &nbsp;<asp:ImageButton ID="ImageButton2" runat="server" CausesValidation="False" CommandName="Delete" ImageUrl="~/Images/DeleteHS.png" OnClick="ImageButton2_Click" Text="Eliminar" OnClientClick="return confirm('¿Está seguro que desea eliminar?'); " />
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <asp:View ID="View2" runat="server">
                <asp:FormView ID="FormView1" runat="server" DataKeyNames="Usuario" DataSourceID="BopDBUsuarioFuncion" DefaultMode="Insert" OnItemInserted="FormView1_ItemInserted" OnItemInserting="FormView1_ItemInserting" Width="1147px">
                    <EditItemTemplate>
                        Usuario:
                ...
                <asp:SqlDataSource ID="BopDBUsuarioFuncion" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" DeleteCommand="DELETE FROM [UsuarioFuncion] WHERE [Usuario] = @Usuario" InsertCommand="p_ValidaInsertaUsuarioFuncion" InsertCommandType="StoredProcedure" SelectCommand="SELECT * FROM [UsuarioFuncion] " UpdateCommand="UPDATE [UsuarioFuncion] SET [Funcion] = @Funcion, [Area] = @Area, [Turno] = @Turno WHERE [Usuario] = @Usuario">
                    <DeleteParameters>
                        <asp:Parameter Name="Usuario" Type="String" />
                    </DeleteParameters>
                    <InsertParameters>
