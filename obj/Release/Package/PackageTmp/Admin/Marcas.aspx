        ...
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            <asp:View ID="View1" runat="server">
                <p>
                    ...
                    &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" OnClick="ImageButton3_Click">Agregar Marca</asp:LinkButton>
                </p>
                <p>
                    ...
                    <asp:SqlDataSource ID="BopDBMarcas" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" DeleteCommand="DELETE FROM [Marcas] WHERE [Codigo] = @original_Codigo AND [Marca] = @original_Marca AND [Estado] = @original_Estado" InsertCommand="p_ValidaInsertaMARCAS" InsertCommandType="StoredProcedure" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Marcas]" UpdateCommand="UPDATE [Marcas] SET [Marca] = @Marca, [Estado] = @Estado WHERE [Codigo] = @original_Codigo AND [Marca] = @original_Marca AND [Estado] = @original_Estado">
                        <DeleteParameters>
