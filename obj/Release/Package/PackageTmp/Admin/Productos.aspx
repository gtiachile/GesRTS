...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h3 class="auto-style11"><strong>PRODUCTOS</strong></h3>
    <p>
        <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
            <asp:View ID="View1" runat="server">
                <p>
                    ...
                    &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" OnClick="ImageButton1_Click">Agregar Producto</asp:LinkButton>
                </p>
                <p>
                    Seleccione Familia:&nbsp;
                ...
                <p>
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Material" DataSourceID="BopDBProdDet" Width="100%" ShowHeaderWhenEmpty="True">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Marca" SortExpression="CodigoMarca">
                                ...
                                <ItemTemplate>
                                    <asp:DropDownList ID="DropDownListMarcaGV0" runat="server" DataSourceID="BopDBMarcasGV0" DataTextField="Marca" DataValueField="Codigo" Enabled="False" SelectedValue='<%# Bind("CodigoMarca") %>'>
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="BopDBMarcasGV0" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" SelectCommand="SELECT [Codigo], [Marca] FROM [Marcas]"></asp:SqlDataSource>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Planta" SortExpression="Planta">
                                ...
                                <ItemTemplate>
                                    <asp:DropDownList ID="DropDownPlantaGV0" runat="server" DataSourceID="BopDBPlantasGV0" DataTextField="Planta" DataValueField="Planta" Enabled="False" SelectedValue='<%# Bind("Planta") %>'>
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="BopDBPlantasGV0" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" SelectCommand="SELECT [Planta], [Descripción] FROM [Plantas]"></asp:SqlDataSource>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Proceso" SortExpression="Proceso">
                                ...
                                <ItemTemplate>
                                    <asp:DropDownList ID="DropDownListProcesoGV0" runat="server" DataSourceID="BopDBProcesosGV0" DataTextField="Descripción" DataValueField="Proceso" Enabled="False" SelectedValue='<%# Bind("Proceso") %>'>
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="BopDBProcesosGV0" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" SelectCommand="SELECT [Proceso], [Descripción] FROM [Procesos]"></asp:SqlDataSource>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Familia" SortExpression="CodigoFamilia">
                                ...
                                <ItemTemplate>
                                    <asp:DropDownList ID="DropDownListFamiliaGV0" runat="server" DataSourceID="BopDBFamiliasGV0" DataTextField="FamiliaProducto" DataValueField="Codigo" Enabled="False" SelectedValue='<%# Bind("CodigoFamilia") %>'>
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="BopDBFamiliasGV0" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" SelectCommand="SELECT [Codigo], [FamiliaProducto] FROM [FamiliaProductos]"></asp:SqlDataSource>
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <asp:View ID="View2" runat="server">
                <asp:FormView ID="FormView1" runat="server" DataKeyNames="Material" DataSourceID="BopDBProductosFV" DefaultMode="Insert" Width="825px">
                    <EditItemTemplate>
                        Material:
                    ...
                    <InsertItemTemplate>
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td class="auto-style23">Peso Neto Caja:</td>
                                <td>
                                    <asp:TextBox ID="PesoNetoCajaTextBox0" runat="server" Text='<%# Bind("PesoNetoCaja") %>' TextMode="Number" Width="70px" />
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style11">Producto:</td>
                                <td class="auto-style12">
                                    <asp:TextBox ID="ProductoTextBox0" runat="server" MaxLength="50" Text='<%# Bind("Producto") %>' Width="224px" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ProductoTextBox0" ErrorMessage="*Obligatorio" Font-Bold="False" ForeColor="Red"></asp:RequiredFieldValidator>
                                </td>
                                <td class="auto-style11">Familia:</td>
                                <td class="auto-style15">
                                    <asp:DropDownList ID="DropDownListFamiliaFV" runat="server" DataSourceID="BopDBFamiliasFV" DataTextField="FamiliaProducto" DataValueField="Codigo" SelectedValue='<%# Bind("CodigoFamila") %>'>
                                    </asp:DropDownList>
                                ...
                                <td class="auto-style24">&nbsp;</td>
                                <td class="auto-style23">Unidad:</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style12">
                                    <asp:DropDownList ID="DropDownListPlantaFV" runat="server" DataSourceID="BopDBPlantasFV" DataTextField="Descripción" DataValueField="Planta" SelectedValue='<%# Bind("Planta") %>'>
                                    </asp:DropDownList>
                                ...
                                <td class="auto-style15">
                                    <asp:TextBox ID="PesoNetoTextBox0" runat="server" Height="16px" Text='<%# Bind("PesoNeto") %>' TextMode="Number" Width="70px" />
                                </td>
                                <td class="auto-style24">&nbsp;</td>
