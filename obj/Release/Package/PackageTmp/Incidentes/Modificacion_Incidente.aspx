        ...
        <table style="border-style: solid; border-width: thin; width:100%;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Label ID="SelFecha" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
                <br />
        ...
        <asp:View ID="View1" runat="server">
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Incidente" DataSourceID="BopDBIncidentes" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="1170px">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Fecha" SortExpression="FechaIncidente">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("FechaIncidente") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Label ID="lblFecha" runat="server" Text='<%# Bind("FechaIncidente") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td class="auto-style49">
                                ...
                                <asp:SqlDataSource ID="BopDBFechasGV" runat="server" ConnectionString="<%$ ConnectionStrings:BopDBConnectionString %>" SelectCommand="p_fechasIngresoMod" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="SelFecha" Name="fechaMod" PropertyName="Text" Type="String" />
