...
ORDER BY Ruta_Nro">
            ...
            <asp:View ID="View2" runat="server">
                <asp:FormView ID="FormView2" runat="server" DataKeyNames="Ruta_Key_RTS" DataSourceID="GesDBRutasFV" Width="817px">
                    <EditItemTemplate>
                        Ruta_Key_RTS:
                    ...
                    <ItemTemplate>
                        <table style="width: 100%;">
                            <tr>
                                <td class="auto-style62">Sesión: </td>
                            ...
                            <tr>
                                <td class="auto-style62">Nº Ruta:&nbsp; </td>
                                <td class="auto-style42">
                                ...
                                <td class="auto-style41">&nbsp;</td>
                                <td class="auto-style63">Descrip.Ruta: </td>
